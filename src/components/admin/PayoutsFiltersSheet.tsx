...
interface PayoutsFiltersSheetProps {
...
const PayoutsFiltersSheet = ({
  ...
  }, [open, transactionTypeFilter, statusFilter, minAmount, maxAmount]);
...
export default PayoutsFiltersSheet;
