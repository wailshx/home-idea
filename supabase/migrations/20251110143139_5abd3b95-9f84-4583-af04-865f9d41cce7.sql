-- Drop and recreate admin_search_disputes function to include support_thread_id
DROP FUNCTION IF EXISTS admin_search_disputes(text,text,text,numeric,numeric,date,date,text,text);
