-- Update admin_get_dispute_details to include attachment_urls as attachments
...
BEGIN
  ...
  SELECT json_build_object(
    'dispute', json_build_object(
      ...
      'support_thread_id', d.support_thread_id,
      'dispute_display_id', d.dispute_display_id,
