-- Restore correct get_host_earnings_report function
-- This version properly uses payouts table for actual financial data
-- and correctly attributes dispute refunds to the listing they were deducted from
