-- Drop all existing versions of host_search_payouts
...
-- Create definitive version with all financial breakdown fields
...
-- Update payout creation trigger to populate all financial fields
