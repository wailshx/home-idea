-- Fix get_host_earnings_report - use correct column names from payouts table
...
BEGIN
  ...
  -- Track cancellation refunds by booking's check-in month (amount is negative for refunds)
  ...
  -- Track dispute refunds by booking's check-in month (amount is negative for refunds to guests)
